...
<div id="navDemo" class="w3-bar-block w3-theme-d2 w3-hide w3-hide-large w3-hide-medium w3-large">
  ...
  <a href="viewnews.php" class="w3-bar-item w3-button w3-padding-large">News</a>
  <a href="gallery/index.php" class="w3-bar-item w3-button w3-padding-large">Gallery</a>
    ...
    <div class="w3-col m3">
      ...
      <div class="w3-card w3-round w3-white">
        <div class="w3-container">
         ...
         <p class="w3-center"><img src="<?php echo 'addteachers/'.$row["photo"];?>" class="w3-circle" style="height:120px;width:120px" ></p>
         <hr>
		...
		while($row=mysqli_fetch_array($result))
		{
			...
			echo '<div class="w3-container w3-card w3-white w3-round w3-margin"><br>
					<div style="margin-bottom:16px; overflow:hidden;">
						...
						if($mid==$email)
						{	
							echo '<a href="delpost.php?id='.$row[0].'" class="w3-btn w3-red">Remove Post</a>';
						}
			echo '</div>
					</div>
			';
    ...
    <div class="w3-col m2">
      <div class="w3-card w3-round w3-white w3-center">
        <div class="w3-container">
          ...
          <p><strong><a href="viewdept.php">Department</a></strong></p>
        </div>
      </div>
      <br>
      <div class="w3-card w3-round w3-white w3-center">
        <div class="w3-container">
          ...
          <p><strong><a href="viewteach.php">Teacher</a></strong></p>
        </div>
      </div>
       <br>
      <div class="w3-card w3-round w3-white w3-center">
        <div class="w3-container">
          <p align="center"><i class="fa fa-user-circle-o w3-xxlarge w3-text-indigo"></i></p>
          <p><strong><a href="viewstud.php">Student</a></strong></p>
        </div>
      </div>
      ...
      <br>
       <div class="w3-card w3-round w3-white w3-center">
        <div class="w3-container">
          ...
          <p><strong><a href="viewattendence.php">Attendence</a></strong></p>
        </div>
      </div>
       ...
       <div class="w3-card w3-round w3-white w3-center">
        <div class="w3-container">
          ...
          <p><strong><a href="viewtimetable.php">Time Table</a></strong></p>
        </div>
      </div>
    ...
    <div class="w3-modal-content w3-card-4 w3-pblack w3-display-middle w3-animate-opacity w3-round-medium"  style="width:450px;">
      <div class="w3-container">
        ...
        <div class="w3-container w3-small">
          <form id="form1" name="form1" enctype="multipart/form-data" method="post" action="savepost.php">
