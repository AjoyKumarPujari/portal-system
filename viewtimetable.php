...
<div class="w3-main w3-round-small" style="margin-left:300px;margin-top:43px;">
	<header class="w3-container w3-border-bottom" style="padding-top:22px; padding-bottom:22px">
    	...
    	<p> <a class="w3-btn w3-right  w3-indigo w3-hover-light-gray w3-round fa fa-plus" href="addtimetable.php"> Add TIMETABLE </a></p>
  	</header>
    	...
    	<table class="w3-table-all">
            ...
            <?php
				...
				while($row=mysql_fetch_array($result))
				{
					...
					echo '<td><a href="deltt.php?id='.$row[0].'" class="w3-btn w3-red" title="Delete"><i class="material-icons">remove_circle</i></a></td>';
					echo '</tr>';	
				}
			?>
        </table>
