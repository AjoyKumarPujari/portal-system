...
<header class="w3-container w3-border-bottom" style="padding-top:22px; padding-bottom:22px">
    <h5><b><i class="fa fa-dashboard"></i> Students/TEACHER</b></h5>
  </header>
  ...
  <div class="w3-card-4 w3-white w3-round " style="width:90%; margin:50px auto; overflow-x:scroll;">
   ...
   <table class="w3-table-all ">
		...
		{
			echo '<tr>';
			echo '<td><a href="professorprofiles.php?mail='.$row["mail"].'"> <img src="./addteachers/'.$row["photo"].'" style="border-radius:50%; width:50px;" title="view profile";/></a></td>';
			echo '<td>'.$row["name"].'</td>';
			echo '<td>'.$row["dept"].'</td>';
			echo '<td>'.$row["sub"].'</td>';
			echo '<td>'.$row[5].'</td>';
