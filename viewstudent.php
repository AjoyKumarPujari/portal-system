...
<div id="navDemo" class="w3-bar-block w3-theme-d2 w3-hide w3-hide-large w3-hide-medium w3-large">
  ...
  <a href="viewtimetables.php" class="w3-bar-item w3-button w3-padding-large">View Time-Table</a>
...
<nav class="w3-sidebar w3-collapse w3-black w3-animate-left" style="z-index:3;width:300px;" id="mySidebar"><br>
  ...
  <div class="w3-bar-block">
    ...
    <a href="viewstudent.php" class="w3-bar-item w3-button w3-padding  w3-light-gray "><i class="fa fa-users fa-fw"></i>  View Students</a>
       <a href="viewtimetables.php" class="w3-bar-item w3-button w3-padding"><i class="fa fa-calendar fa-fw"></i>  View Time-Table</a>
...
<header class="w3-container w3-border-bottom" style="padding-top:22px; padding-bottom:22px">
    <h5><b><i class="fa fa-dashboard"></i> Students/STUDENT</b></h5>
  </header>
  
  <div class="w3-card-4 w3-white w3-round " style="width:95%; margin:50px auto; overflow-X:scroll;">
   ...
   <table class="w3-table-all w3-small">
                	<tr>
                     ...
                     <?php
						...
						{
							echo '<tr>';
							echo '<td><a href="studentprofile.php?mail='.$row["mail"].'"> <img src="./addstudents/'.$row["photo"].'" style="border-radius:50%; width:50px;" title="View Profile"/></a></td>';
							echo '<td>'.$row["name"].'</td>';
