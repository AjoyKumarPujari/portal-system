...
<nav class="w3-sidebar w3-collapse w3-black w3-animate-left" style="z-index:3;width:300px;" id="mySidebar"><br>
  ...
  <div class="w3-bar-block">
    ...
    <a href="../addteachers/viewteacher.php" class="w3-bar-item w3-button w3-padding"><i class="fa fa-users fa-fw"></i>  View Teachers</a>
    <a href="viewstudent.php" class="w3-bar-item w3-button w3-padding w3-light-gray"><i class="fa fa-users fa-fw"></i>  View Students</a>
...
<div class="w3-main" style="margin-left:300px;margin-top:43px;">
  ...
  <div class="w3-card-4 w3-white w3-round w3-border w3-border-black " style="width:70%; margin:50px auto;">
    	<div class="w3-container w3-white w3-border-black w3-center w3-border-bottom">
        ...
        <div class="w3-container w3-padding-12">
         <form name="form1" id="form1" class="w3-container" enctype="multipart/form-data" method="post" action="upstudents.php">
         ...
         <input class="w3-input w3-border " type="hidden"  value="<?php echo $row["id"]; ?>" name="id" required><br>
          ...
          <input class="w3-input w3-border" type="text"  value="<?php echo $row["rollno"]; ?>" name="rollno" required> 
       ...
       <?php
		...
		?>
          <input class="w3-input w3-border" type="text"  value="<?php echo $row["sem"]; ?>" name="sem" required><br>

          <input class="w3-input w3-border" type="text"  value="<?php echo $row["address"];?>" name="address" required><br>
          ...
          <input type="text" id="Datepicker1" name="dob" class="w3-input w3-border" value="<?php echo $row["dob"]; ?>"><br>
          
          <input class="w3-input w3-border" type="text"  value="<?php echo $row["school"]; ?>" name="school" required><br>
           
          <input class="w3-input w3-border" type="text"  value="<?php echo $row["college"]; ?>" name="college" required><br>
        ...
        <form name="form2" id="form2" class="w3-container" enctype="multipart/form-data" method="post" action="upstudents.php">
