...
<nav class="w3-sidebar w3-collapse w3-black w3-animate-left" style="z-index:3;width:300px;" id="mySidebar"><br>
  ...
  <div class="w3-bar-block">
    ...
    <a href="viewdept.php" class="w3-bar-item w3-button w3-padding w3-light-gray"><i class="fa fa-users fa-fw"></i>  View Departments</a>
...
<div class="w3-main" style="margin-left:300px;margin-top:43px;">
  ...
  <div class="w3-card-4 w3-white w3-round w3-border w3-border-black " style="width:70%; margin:50px auto;">
        ...
        <div class="w3-container w3-padding-12">
         <form name="form1" id="form1" class="w3-container" enctype="multipart/form-data" method="post" action="updept.php">
         
         <input class="w3-input w3-border-botttom w3-border-black " type="hidden"  value="<?php echo $row["id"]; ?>" name="id" required><br>
