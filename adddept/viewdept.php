...
<nav class="w3-sidebar w3-collapse w3-black w3-animate-left" style="z-index:3;width:300px;" id="mySidebar"><br>
  ...
  <div class="w3-bar-block">
    ...
    <a href="viewdept.php" class="w3-bar-item w3-button w3-padding  w3-light-gray"><i class="fa fa-building fa-fw"></i>   Departments</a>
...
<div class="w3-main" style="margin-left:300px;margin-top:43px;">
  <header class="w3-container w3-border-bottom" style="padding-top:22px; padding-bottom:22px">
    <h5><b><i class="fa fa-dashboard"></i> Admin Panel</b>/Department</b></h5>
    <p> <a class="w3-btn w3-right  w3-indigo w3-round w3-hover-light-gray fa fa-plus" href="index.php"> ADD DEPARTMENT </a></p>
  </header>
  
  <div class="w3-card-4 w3-white w3-round w3-border-black w3-border " style="width:70%; margin:50px auto;">
    	<div class="w3-container w3-round w3-border-black w3-border-bottom w3-white">
        	<h5 align="center">DEPARTMENT DETAILS  </h5>
		...
		while($row=mysql_fetch_array($result))
		{
			...
			echo '<td>'.$row[2].'</td>';
							...
							echo '<td><a href="editdept.php?id='.$row[0].'" class="w3-btn w3-indigo w3-small" title="EDIT"><i class="fa fa-pencil-square-o w3-large"></i></a></td>';	
