...
<nav class="w3-sidebar w3-collapse w3-black w3-animate-left" style="z-index:3;width:300px;" id="mySidebar"><br>
  ...
  <div class="w3-bar-block">
    ...
    <a href="viewtimetables.php" class="w3-bar-item w3-button w3-padding "><i class="fa fa-calendar fa-fw"></i>  View timetables</a>
    <a href="viewattendences.php" class="w3-bar-item w3-button w3-padding w3-light-gray"><i class="fa fa-book fa-fw"></i>  View attendance</a>
...
<div class="w3-main w3-round-small" style="margin-left:300px;margin-top:43px;">
   ...
   <div class="w3-card-4 w3-white w3-round " style="width:90%; margin:50px auto; overflow-x:scroll;">
        ...
        </div><table class="w3-table-all w3-small">
                	<tr>
                    	<td> Department</td>
                        <td>Semester</td>
                        <td>Roll no</td>
