...
<nav class="w3-sidebar w3-collapse w3-black w3-animate-left" style="z-index:3;width:300px;" id="mySidebar"><br>
  ...
  <div class="w3-bar-block">
    ...
    <a href="viewtimetable.php" class="w3-bar-item w3-button w3-padding w3-light-gray"><i class="fa fa-calendar fa-fw"></i>  View timetables</a>
...
<header class="w3-container w3-border-bottom" style="padding-top:22px; padding-bottom:22px">
    ...
    <p> <a class="w3-btn w3-right  w3-indigo w3-hover-light-gray w3-round fa fa-eye" href="viewtimetable.php"> VIEW TIMETABLE </a></p>
  </header>
  <div class="w3-card-4 w3-white w3-round " style="width:70%; margin:50px auto;">
    	<div class="w3-container w3-dark-gray w3-round">
        	<h5 align="center">ADD TIMETABLE </h5>
        </div>
        
        <div class="w3-container w3-padding-12"><br>
         <form name="form1" id="form1" class="w3-container w3-round w3-center" enctype="multipart/form-data" method="post" action="addtimetableact.php">
         
        <p><input  type="file" name="file1" id="file1" class="w3-input w3-border w3-white" ></p>
         
         <p><input  name="detail"  type="text" required class="w3-input w3-border " placeholder="Enter Details"></p>
