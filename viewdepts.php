...
<nav class="w3-sidebar w3-collapse w3-black w3-animate-left" style="z-index:3;width:300px;" id="mySidebar"><br>
  ...
  <div class="w3-bar-block">
    ...
    <a href="viewdepts.php" class="w3-bar-item w3-button w3-padding w3-light-gray  "><i class="fa fa-building-o fa-fw"></i>  view Department</a>
    ...
    <a href="viewstudent.php" class="w3-bar-item w3-button w3-padding "><i class="fa fa-users fa-fw"></i>  View Students</a>   
        <a href="viewtimetables.php" class="w3-bar-item w3-button w3-padding "><i class="fa fa-calendar fa-fw"></i>  View Time-Tables</a>   
...
<header class="w3-container w3-border-bottom" style="padding-top:22px; padding-bottom:22px">
    <h5><b><i class="fa fa-dashboard"></i> Students/DEPARTMENT</b></h5>
  </header>
