...
<div class="w3-main" style="margin-left:300px;margin-top:43px;">
  ...
  <header class="w3-container w3-border-bottom" style="padding-top:22px; padding-bottom:22px">
    <h5><b><i class="fa fa-dashboard"></i> Admin Panel</b>/Add News</h5>
     <p> <a class="w3-btn w3-right  w3-indigo w3-hover-light-gray w3-round fa fa-eye" href="viewnews.php"> VIEW NEWS </a></p>
  </header>
  
  <div class="w3-card-4 w3-white w3-round " style="width:70%; margin:50px auto;">
    	<div class="w3-container w3-dark-gray w3-round">
        	<h5 align="center">ADD NEWS </h5>
        </div>
        
        <div class="w3-container w3-padding-12"><br>
         <form name="form1" id="form1" class="w3-container w3-round w3-center" enctype="multipart/form-data" method="post" action="addnews.php">
         
         <input  name="headline"  type="text" required class="w3-input w3-border " placeholder="Enter Headline"><br>
         
        
        
         <textarea name="news" id="textarea" required class="w3-input w3-border " placeholder="Enter Details"></textarea>
         <br>
