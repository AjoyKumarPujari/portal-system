...
<div class="w3-top">
 <div class="w3-bar w3-indigo w3-left-align w3-large">
  ...
  <a href="wall.php" class="w3-bar-item w3-button w3-padding-large w3-indigo"><i class="fa fa-home w3-margin-right"></i>AAU COMMUNITY</a>
...
<div id="navDemo" class="w3-bar-block w3-indigo w3-hide w3-hide-large w3-hide-medium w3-large">
  ...
  <a href="viewtimetable.php" class="w3-bar-item w3-button w3-padding-large">Attendence</a>
...
<div class="w3-content w3-margin-top" style="max-width:1400px;">
  ...
  <div class="w3-row-padding ">
    ...
    <div class="w3-third " >
      ...
      <div class="w3-white w3-text-grey w3-card-4">
        <div class="w3-display-container w3-center">
         <img src="<?php echo 'addteachers/'.$row["photo"];?>" width="434" height="290" \>
        ...
        <div class="w3-container w3-padding-4">
          ...
          <p><i class="fa fa-briefcase fa-fw w3-margin-right w3-large w3-text-indigo"></i>TEACHER</p>
    ...
    <div class="w3-twothird  ">
      <div class="w3-container w3-card w3-white  w3-padding "  style="height:450px"><br>
      <hr>
        ...
        <?php echo $row["dept"]; ?>
        <br>
        <h4 class="w3-text-grey w3-padding-3"><i class="fa fa-book fa-fw w3-margin-right w3-xxlarge w3-text-indigo"></i>Subject</h4>
       <?php echo $row["sub"]; ?>   
        <br>
