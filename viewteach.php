...
<nav class="w3-sidebar w3-collapse w3-black w3-animate-left" style="z-index:3;width:300px;" id="mySidebar"><br>
  ...
  <div class="w3-bar-block">
    ...
    <a href="viewteach.php" class="w3-bar-item w3-button w3-padding w3-light-gray "><i class="fa fa-users fa-fw"></i>  View Teachers</a>
    <a href="viewstud.php" class="w3-bar-item w3-button w3-padding "><i class="fa fa-users fa-fw"></i>  View Students</a>    
    <a href="viewtimetable.php" class="w3-bar-item w3-button w3-padding"><i class="fa fa-calendar fa-fw"></i>  View timetables</a>
   
    <a href="viewattendence.php" class="w3-bar-item w3-button w3-padding"><i class="fa fa-book fa-fw"></i>  View Attendence  </a>
...
<header class="w3-container w3-border-bottom" style="padding-top:22px; padding-bottom:22px">
    <h5><b><i class="fa fa-dashboard"></i> Teachers/TEACHERS</b></h5>
  </header>
  ...
  <div class="w3-card-4 w3-white w3-round " style="width:90%; margin:50px auto; overflow-X:scroll;">
    	<div class="w3-container w3-round w3-white">
        	<h5 align="center">TEACHERS DETAILS: </h5>
        </div>
   	<table class="w3-table-all ">
		...
		{
			echo '<tr>';
			echo '<td><a href="professorprofile.php?mail='.$row["mail"].'"> <img src="./addteachers/'.$row["photo"].'" style="border-radius:50%; width:50px;" title="view profile";/></a></td>';
			echo '<td>'.$row["name"].'</td>';
			echo '<td>'.$row["dept"].'</td>';
			echo '<td>'.$row["sub"].'</td>';
			echo '<td>'.$row["add"].'</td>';
