...
<header class="w3-container w3-border-bottom" style="padding-top:22px; padding-bottom:22px">
    <h5><b><i class="fa fa-dashboard"></i> Students/NEWS</b></h5>
  </header>
  
  <div class="w3-card-4 w3-white w3-round " style="width:55%; margin:50px auto;">
    	<div class="w3-container w3-round w3-gray">
        	<h5 align="center">LATEST NEWS  <a href="viewallnewses.php" class="w3-bar-item w3-button w3-hide-small w3-right w3-padding-large w3-hover-white w3-small fa fa-eye" title="View All">View All...
