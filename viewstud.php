...
<nav class="w3-sidebar w3-collapse w3-black w3-animate-left" style="z-index:3;width:300px;" id="mySidebar"><br>
  ...
  <div class="w3-bar-block">
    ...
    <a href="viewstud.php" class="w3-bar-item w3-button w3-padding w3-light-gray "><i class="fa fa-users fa-fw"></i>  View Students</a>    
...
<header class="w3-container w3-border-bottom" style="padding-top:22px; padding-bottom:22px">
    <h5><b><i class="fa fa-dashboard"></i> Teachers/STUDENT</b></h5>
  </header>
   	...
   	<table class="w3-table-all w3-small">
                	<tr>
                     ...
                     <?php
						...
						{
							echo '<tr>';
							echo '<td><a href="studentprofilep.php?mail='.$row["mail"].'"> <img src="./addstudents/'.$row["photo"].'" style="border-radius:50%; width:50px;" title="View Profile"/></a></td>';
							echo '<td>'.$row["name"].'</td>';
